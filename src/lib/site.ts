export const siteLinks = {
  ...
  installer: "https://github.com/harshittpanday/Flint/releases/download/v0.5/Flint_0.3.0_x64-setup.exe",
  release: "https://github.com/harshittpanday/Flint/releases/tag/v0.5",
